...
class FlightActionMaskModel(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.name = name
        action_mask_len = obs_space["action_mask"].shape[0]
        obs_len = 0
        for obs in obs_space.spaces.values():
            obs_len += obs.shape[0]
        self.input_shape = obs_len - action_mask_len
    ...
    def forward(self, input_dict):
        ...
        Returns:
            outputs: The model output tensor of size
                [BATCH, num_outputs]
        """
...
class FlightActionMaskRNNModel(nn.Module):
    def __init__(self,
                 obs_space,
                 action_space,
                 lstm_state_size=64,
